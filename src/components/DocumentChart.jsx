      ...
      <div className="space-y-4">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={data}>
            ...
            <Legend />
            <Line type="monotone" dataKey="documents" stroke="hsl(var(--info))" strokeWidth={2} name="Total Documents" dot={{ fill: 'hsl(var(--info))' }}/>
            <Line type="monotone" dataKey="approved" stroke="hsl(var(--success))" strokeWidth={2} name="Approved" dot={{ fill: 'hsl(var(--success))' }}/>
